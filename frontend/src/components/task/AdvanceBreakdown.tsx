...
export function AdvanceBreakdown({ task }: Props) {
  ...
  return (
    <div className="rounded-lg border border-white/[0.08] bg-surface-card p-5 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* Advance */}
        <div className="rounded-lg bg-accent-teal/10 border border-accent-teal/20 px-4 py-3">
          <div className="flex items-center gap-1.5 text-accent-teal mb-2">
